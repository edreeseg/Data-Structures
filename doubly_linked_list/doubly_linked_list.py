...
class DoublyLinkedList:
    ...
    def remove_from_head(self):
        current_head = self.head
        if current_head:
            self.head = current_head.next if current_head.next else None
        if current_head is self.tail:
            self.tail = None
        self.length-=1
    ...
    def remove_from_tail(self):
        current_tail = self.tail
        if current_tail:
            self.tail = current_tail.prev if current_tail.prev else None
        if current_tail is self.head:
            self.head = None
        self.length-=1
